...
const ContactPage: React.FC = () => {
  ...
  return (
    <div style={{ margin: 0, background: "#F8FAFC", color: "#1F2937", fontFamily: "Segoe UI, system-ui, -apple-system, Helvetica Neue, Arial, Noto Sans, Liberation Sans, sans-serif" }}>
      {/* Header */}
      <header style={{ width: "100%", background: "#FFFFFF", boxShadow: "0 2px 8px rgba(15,23,42,0.06)", padding: "20px 28px", display: "flex", justifyContent: "center" }}>
        <div ref={headerInnerRef} style={{ width: "100%", maxWidth: "1100px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "20px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "18px" }}>
            <img src="logo1.png" alt="Allen City Pharmacy Logo" style={{ height: "64px", width: "auto" }} />
          </div>
          <nav style={{ display: "flex", gap: "28px", alignItems: "center" }}>
            <a href="index.html" style={{ textDecoration: "none", fontWeight: 600, fontSize: 16, color: "#374151" }}>Home</a>
            <a href="about.html" style={{ textDecoration: "none", fontWeight: 600, fontSize: 16, color: "#374151" }}>About</a>
            <a href="shop.html" style={{ textDecoration: "none", fontWeight: 600, fontSize: 16, color: "#374151" }}>Shop</a>
            <a href="#" style={{ textDecoration: "none", fontWeight: 700, fontSize: 16, color: "#065F46", borderBottom: "3px solid #065F46", paddingBottom: 6 }}>Contact</a>
          </nav>
        </div>
      </header>
